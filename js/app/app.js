...
app.controller('homeController', function($scope, $http) {
	$http.get('home.json').then(function(res) {
		$scope.data = res.data;
	});
});
...
app.controller('categoryController', function($scope, $http, $routeParams) {
	...
	$http.get('category' + $categoryId + '.json').then(function(res) {
		$scope.data = res.data;
	});
});
...
app.controller('topicController', function($scope, $http, $routeParams) {
	...
	$http.get('topic.json').then(function(res) {
		$scope.data = res.data;
...
app.controller('navbarController', function($scope, $http) {
	$http.get('navbar.json').then(function(res) {
		$scope.data = res.data;
	});
});
